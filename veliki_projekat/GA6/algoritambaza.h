...
protected:
    ...
    QVector<QPolygonF> ucitajPodatkeIzDatotekePoligoni(std::string imeDatoteke) const;
    QVector<QPolygonF> generisiNasumicnePoligone(int minVertices, int maxVertices,int numPolygons) const;
